...
* Create or update `docs/00_requirements/requirements.inventory.md`
...
* Generate an inconsistencies report under:
  `docs/build/reports/inventory_inconsistencies/`
...
* Update `docs/00_requirements/requirements.inventory.md` only.
