 ...
 * 
 * When run from the command line, it uses the default workspace-relative logo path.
 * When invoked from VS Code extension commands, the logo path can be provided
 * via AssetResolver to use the extension's bundled logo.
 * 
 * Usage:
 *   npm run export:pdf
